...
const checks = [
  ...
  () => assertContains('sql/kingbase/survey_004_task.sql', 'survey/task/index'),
  () => assertContains('sql/kingbase/survey_004_task.sql', "survey:task:list"),
  () => assertContains('sql/kingbase/nocontact_004_full_alignment.sql', 'survey/designer/index'),
