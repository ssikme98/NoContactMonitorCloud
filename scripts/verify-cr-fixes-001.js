...
const overviewCtrl = read('ruoyi-modules/ruoyi-survey/src/main/java/com/ruoyi/survey/controller/SurveyOverviewController.java');
...
const questionnaireSvc = read('ruoyi-modules/ruoyi-survey/src/main/java/com/ruoyi/survey/service/impl/SurveyQuestionnaireServiceImpl.java');
...
const analyticsSvc = read('ruoyi-modules/ruoyi-survey/src/main/java/com/ruoyi/survey/service/impl/SurveyAnalyticsServiceImpl.java');
